...
public class UpdateUserPage extends JFrame {
	 ...
	 * Create the frame.
	 */
	public UpdateUserPage(UserEntity user) {
		...
		lblNewLabel.setBounds(399, 10, 389, 28);
		...
		roletxt.setSelectedItem(user.getRole());
